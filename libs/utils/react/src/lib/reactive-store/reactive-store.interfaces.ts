...
export type OnInitListener = (callWhenReady: OnInitialized, deps?: any[]) => void;
 ...
 */
export type StateCreator<T extends State> = (store: StoreAPI<T>, useStoreEffect: OnInitListener) => T;
